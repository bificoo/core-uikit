...
function computeAutoPlacement(state, options) {
  ...
  var overflows = allowedPlacements.reduce(function (acc, placement) {
    acc[placement] = detectOverflow['default'](state, {
      placement: placement,
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding
    })[getBasePlacement['default'](placement)];
    return acc;
  }, {});
