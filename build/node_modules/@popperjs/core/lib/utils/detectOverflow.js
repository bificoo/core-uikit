...
function detectOverflow(state, options) {
  ...
  var clippingClientRect = getClippingRect['default'](instanceOf.isElement(element) ? element : element.contextElement || getDocumentElement['default'](state.elements.popper), boundary, rootBoundary);
  var referenceClientRect = getBoundingClientRect['default'](referenceElement);
