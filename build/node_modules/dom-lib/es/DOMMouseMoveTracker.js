...
var cancelAnimationFramePolyfill = require('./animation/cancelAnimationFramePolyfill.js');
...
function () {
  ...
  function DOMMouseMoveTracker(onMove, onMoveEnd, domNode) {
    ...
    _defineProperty(this, "onMouseMove", function (event) {
      ...
      if (_this.animationFrameID === null) {
        ...
        _this.animationFrameID = requestAnimationFramePolyfill['default'](_this.didMouseMove);
      }
  ...
  _proto.captureMouseMoves = function captureMouseMoves(event) {
    if (!this.eventMoveToken && !this.eventUpToken) {
      this.eventMoveToken = on['default'](this.domNode, 'mousemove', this.onMouseMove);
      this.eventUpToken = on['default'](this.domNode, 'mouseup', this.onMouseUp);
    }
  ...
  _proto.releaseMouseMoves = function releaseMouseMoves() {
    ...
    if (this.animationFrameID !== null) {
      cancelAnimationFramePolyfill['default'](this.animationFrameID);
