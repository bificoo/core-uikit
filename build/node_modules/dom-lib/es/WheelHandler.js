...
var normalizeWheel = require('./normalizeWheel.js');
var requestAnimationFramePolyfill = require('./animation/requestAnimationFramePolyfill.js');
...
function () {
  function WheelHandler(onWheel, handleScrollX, handleScrollY, stopPropagation) {
    ...
    if (typeof handleScrollX !== 'function') {
      handleScrollX = handleScrollX ? emptyFunction['default'].thatReturnsTrue : emptyFunction['default'].thatReturnsFalse;
    }

    if (typeof handleScrollY !== 'function') {
      handleScrollY = handleScrollY ? emptyFunction['default'].thatReturnsTrue : emptyFunction['default'].thatReturnsFalse;
    }

    if (typeof stopPropagation !== 'function') {
      stopPropagation = stopPropagation ? emptyFunction['default'].thatReturnsTrue : emptyFunction['default'].thatReturnsFalse;
    }
  ...
  _proto.onWheel = function onWheel(event) {
    var normalizedEvent = normalizeWheel['default'](event);
    ...
    if (changed === true && this.animationFrameID === null) {
      this.animationFrameID = requestAnimationFramePolyfill['default'](this.didWheel);
    }
  };
