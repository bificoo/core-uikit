...
index.elementResizeEvent.exports =
  typeof window === "undefined" ? _exports : _exports.bind(window);

var unbind = index.elementResizeEvent.exports.unbind = function (element, fn) {
  var attachEvent = document.attachEvent;
...
var bindElementResize = index.elementResizeEvent.exports;

exports['default'] = bindElementResize;
