...
require('./isBuffer.js');
var isMap$1 = require('./isMap.js');
var isObject$1 = require('./isObject.js');
var isSet$1 = require('./isSet.js');
var keys$1 = require('./keys.js');
var keysIn$1 = require('./keysIn.js');
var _cloneBuffer = require('../../_virtual/_cloneBuffer.js_commonjs-module');
var isBuffer$1 = require('../../_virtual/isBuffer.js_commonjs-module');

var Stack = _Stack['default'],
    arrayEach = _arrayEach['default'],
    assignValue = _assignValue['default'],
    baseAssign = _baseAssign['default'],
    baseAssignIn = _baseAssignIn['default'],
    cloneBuffer = _cloneBuffer._cloneBuffer.exports,
    copyArray = _copyArray['default'],
    copySymbols = _copySymbols['default'],
    copySymbolsIn = _copySymbolsIn['default'],
    getAllKeys = _getAllKeys['default'],
    getAllKeysIn = _getAllKeysIn['default'],
    getTag = _getTag['default'],
    initCloneArray = _initCloneArray['default'],
    initCloneByTag = _initCloneByTag['default'],
    initCloneObject = _initCloneObject['default'],
    isArray = isArray$1['default'],
    isBuffer = isBuffer$1.isBuffer.exports,
    isMap = isMap$1['default'],
    isObject = isObject$1['default'],
    isSet = isSet$1['default'],
    keys = keys$1['default'],
