...
var baseMatches = _baseMatches['default'],
    baseMatchesProperty = _baseMatchesProperty['default'],
    identity = identity$1['default'],
    isArray = isArray$1['default'],
    property = property$1['default'];
