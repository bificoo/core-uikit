...
var baseSetData = _baseSetData['default'],
    createBind = _createBind['default'],
    createCurry = _createCurry['default'],
    createHybrid = _createHybrid['default'],
    createPartial = _createPartial['default'],
    getData = _getData['default'],
    mergeData = _mergeData['default'],
    setData = _setData['default'],
    setWrapToString = _setWrapToString['default'],
    toInteger = toInteger$1['default'];
