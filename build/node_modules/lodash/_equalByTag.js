...
var Symbol = _Symbol['default'],
    Uint8Array = _Uint8Array['default'],
    eq = eq$1['default'],
    equalArrays = _equalArrays['default'],
    mapToArray = _mapToArray['default'],
    setToArray = _setToArray['default'];
