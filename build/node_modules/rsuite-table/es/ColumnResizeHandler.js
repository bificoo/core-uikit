...
var ColumnResizeHandler = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  ...
  var handleMove = useCallback(function (deltaX) {
    ...
    columnWidth.current = clamp_1((defaultColumnWidth || 0) + (rtl ? -cursorDelta.current : cursorDelta.current), minWidth ? Math.max(minWidth, RESIZE_MIN_WIDTH) : RESIZE_MIN_WIDTH, 20000);
