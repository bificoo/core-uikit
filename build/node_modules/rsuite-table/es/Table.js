...
import React__default, { useReducer, useState, useRef, useCallback, useImperativeHandle } from 'react';
import { getTranslateDOMPositionXY } from '../../dom-lib/esm/translateDOMPositionXY.js';
import PropTypes from '../../prop-types/index.js';
import isFunction_1 from '../../lodash/isFunction.js';
import flatten_1 from '../../lodash/flatten.js';
...
import { EXPANDED_KEY, TREE_DEPTH, SCROLLBAR_WIDTH, SORT_TYPE, CELL_PADDING_HEIGHT } from './constants.js';
import './utils/prefix.js';
import '../../lodash/isPlainObject.js';
import mergeCells from './utils/mergeCells.js';
import flattenData from './utils/flattenData.js';
import './utils/translateDOMPositionXY.js';
import isRTL from './utils/isRTL.js';
import findRowKeys from './utils/findRowKeys.js';
import findAllParents from './utils/findAllParents.js';
import shouldShowRowByExpanded from './utils/shouldShowRowByExpanded.js';
import resetLeftForCells from './utils/resetLeftForCells.js';
...
import useCellDescriptor from './utils/useCellDescriptor.js';
import useTableDimension from './utils/useTableDimension.js';
import useTableRows from './utils/useTableRows.js';
import useAffix from './utils/useAffix.js';
import useScrollListener from './utils/useScrollListener.js';
import usePosition from './utils/usePosition.js';
import isSupportTouchEvent from './utils/isSupportTouchEvent.js';
...
var Table = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  ...
  var _useControlled = useControlled(expandedRowKeysProp, defaultExpandAllRows ? findRowKeys(dataProp, rowKey, isFunction_1(renderRowExpandedProp)) : defaultExpandedRowKeys || []),
  ...
  var shouldFixedColumn = Array.from(flatten_1(children)).some(function (child) {
    var _child$props;
  ...
  var renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    if (shouldFixedColumn && contentWidth.current > tableWidth.current) {
      ...
      rowNode = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, fixedLeftCellGroupWidth ? /*#__PURE__*/React__default.createElement(CellGroup, {
        fixed: "left",
      ...
      }, mergeCells(resetLeftForCells(fixedLeftCells))) : null, /*#__PURE__*/React__default.createElement(CellGroup, null, mergeCells(scrollCells)), fixedRightCellGroupWidth ? /*#__PURE__*/React__default.createElement(CellGroup, {
        fixed: "right",
        style: rtl ? {
          right: 0 - rowRight
        } : {
      ...
      rowNode = /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(CellGroup, null, mergeCells(cells)), shouldRenderExpandedRow && renderRowExpanded(rowData));
    }

    return /*#__PURE__*/React__default.createElement(Row, _extends({}, restRowProps, {
      "data-depth": depth,
      style: rowStyles
  ...
  var renderTableHeader = function renderTableHeader(headerCells, rowWidth) {
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, (affixHeader === 0 || affixHeader) && header, /*#__PURE__*/React__default.createElement("div", {
      role: "rowgroup",
  ...
  var shouldRenderExpandedRow = useCallback(function (rowData) {
    if (isFunction_1(renderRowExpandedProp) && !isTree && rowKey && expandedRowKeys.some(function (key) {
  ...
  var renderRowData = function renderRowData(bodyCells, rowData, props, shouldRenderExpandedRow) {
    ...
    for (var i = 0; i < bodyCells.length; i++) {
      ...
      cells.push( /*#__PURE__*/React__default.cloneElement(cell, {
  ...
  var renderTableBody = function renderTableBody(bodyCells, rowWidth) {
    ...
    return /*#__PURE__*/React__default.createElement("div", {
      ...
      ref: wheelWrapperRef
    }, topHideHeight ? /*#__PURE__*/React__default.createElement(Row, {
      style: topRowStyles,
      className: "virtualized"
    }) : null, visibleRows.current, bottomHideHeight ? /*#__PURE__*/React__default.createElement(Row, {
      style: bottomRowStyles,
      className: "virtualized"
    }) : null), /*#__PURE__*/React__default.createElement(EmptyMessage, {
      locale: locale,
    ...
    }), renderScrollbar(), /*#__PURE__*/React__default.createElement(Loader, {
      locale: locale,
  ...
  return /*#__PURE__*/React__default.createElement(TableContext.Provider, {
    ...
    style: styles,
    ref: tableRef
  }), showHeader && renderTableHeader(headerCells, rowWidth), children && renderTableBody(bodyCells, rowWidth), showHeader && /*#__PURE__*/React__default.createElement(MouseArea, {
    ref: mouseAreaRef,
    addPrefix: prefix,
    headerHeight: headerHeight,
    height: getTableHeight()
