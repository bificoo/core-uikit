...
import { SORT_TYPE, EXPANDED_KEY, TREE_DEPTH, SCROLLBAR_WIDTH, CELL_PADDING_HEIGHT } from './constants.js';
...
var Table = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
  ...
  var shouldRenderExpandedRow = useCallback(function (rowData) {
    return isFunction_1(renderRowExpandedProp) && !isTree && expandedRowKeys.some(function (key) {
