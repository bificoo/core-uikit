...
var eq = require('../../lodash/eq.js');
var omit = require('../../lodash/omit.js');
var merge = require('../../lodash/merge.js');
var index$1 = require('../../element-resize-event/index.js');
require('../../dom-lib/lib/transition/translateDOMPositionXY.js');
var addStyle = require('../../dom-lib/es/style/addStyle.js');
var scrollTop = require('../../dom-lib/es/query/scrollTop.js');
var scrollLeft = require('../../dom-lib/es/query/scrollLeft.js');
var getOffset = require('../../dom-lib/es/query/getOffset.js');
var getHeight = require('../../dom-lib/es/query/getHeight.js');
var getWidth = require('../../dom-lib/es/query/getWidth.js');
var on = require('../../dom-lib/es/events/on.js');
...
var WheelHandler = require('../../dom-lib/es/WheelHandler.js');
...
var getTotalByColumns = require('./utils/getTotalByColumns.js');
var mergeCells = require('./utils/mergeCells.js');
var toggleClass = require('./utils/toggleClass.js');
var flattenData = require('./utils/flattenData.js');
require('./utils/translateDOMPositionXY.js');
var isRTL = require('./utils/isRTL.js');
var findRowKeys = require('./utils/findRowKeys.js');
var findAllParents = require('./utils/findAllParents.js');
var shouldShowRowByExpanded = require('./utils/shouldShowRowByExpanded.js');
var resetLeftForCells = require('./utils/resetLeftForCells.js');
var isNumberOrTrue = require('./utils/isNumberOrTrue.js');
var requestAnimationTimeout = require('./utils/requestAnimationTimeout.js');
var ColumnGroup = require('./ColumnGroup.js');
var translateDOMPositionXY = require('../../../_virtual/translateDOMPositionXY.js_commonjs-exports');
...
var propTypes = {
  autoHeight: index['default'].bool,
  affixHeader: index['default'].oneOfType([index['default'].bool, index['default'].number]),
  affixHorizontalScrollbar: index['default'].oneOfType([index['default'].bool, index['default'].number]),
  bordered: index['default'].bool,
  bodyRef: index['default'].func,
  className: index['default'].string,
  classPrefix: index['default'].string,
  children: index['default'].any,
  cellBordered: index['default'].bool,
  data: index['default'].arrayOf(index['default'].object),
  defaultExpandAllRows: index['default'].bool,
  defaultExpandedRowKeys: index['default'].arrayOf(index['default'].oneOfType([index['default'].string, index['default'].number])),
  defaultSortType: index['default'].oneOfType([index['default'].bool, index['default'].string]),
  disabledScroll: index['default'].bool,
  expandedRowKeys: index['default'].arrayOf(index['default'].oneOfType([index['default'].string, index['default'].number])),
  hover: index['default'].bool,
  height: index['default'].number,
  headerHeight: index['default'].number,
  locale: index['default'].object,
  loading: index['default'].bool,
  loadAnimation: index['default'].bool,
  minHeight: index['default'].number,
  rowKey: index['default'].oneOfType([index['default'].string, index['default'].number]),
  rowHeight: index['default'].oneOfType([index['default'].number, index['default'].func]),
  renderTreeToggle: index['default'].func,
  renderRowExpanded: index['default'].func,
  rowExpandedHeight: index['default'].number,
  renderEmpty: index['default'].func,
  renderLoading: index['default'].func,
  rowClassName: index['default'].oneOfType([index['default'].func, index['default'].string]),
  rtl: index['default'].bool,
  style: index['default'].object,
  sortColumn: index['default'].string,
  sortType: index['default'].oneOfType([index['default'].bool, index['default'].string]),
  showHeader: index['default'].bool,
  shouldUpdateScroll: index['default'].bool,
  translate3d: index['default'].bool,
  wordWrap: index['default'].bool,
  width: index['default'].number,
  virtualized: index['default'].bool,
  isTree: index['default'].bool,
  onRowClick: index['default'].func,
  onRowContextMenu: index['default'].func,
  onScroll: index['default'].func,
  onSortColumn: index['default'].func,
  onExpandChange: index['default'].func,
  onTouchStart: index['default'].func,
  onTouchMove: index['default'].func,
  onDataUpdated: index['default'].func
};

var Table = /*#__PURE__*/function (_React$Component) {
  inheritsLoose['default'](Table, _React$Component);
  ...
  Table.getDerivedStateFromProps = function getDerivedStateFromProps(props, state) {
    if (props.data !== state.cacheData || props.isTree !== state.isTree) {
      return {
        ...
        isTree: props.isTree,
        data: props.isTree ? flattenData['default'](props.data) : props.data
      };
    }
  ...
  function Table(props) {
    ...
    _this.setOffsetByAffix = function () {
      ...
      if (isNumberOrTrue['default'](affixHeader) && headerNode) {
        _this.setState(function () {
          return {
            headerOffset: getOffset['default'](headerNode)
          };
        });
      }
      ...
      if (isNumberOrTrue['default'](affixHorizontalScrollbar) && tableNode) {
        _this.setState(function () {
          return {
            tableOffset: getOffset['default'](tableNode)
          };
        });
      }
    };
    ...
    _this.handleWindowScroll = function () {
      ...
      if (isNumberOrTrue['default'](affixHeader)) {
        _this.affixTableHeader();
      }

      if (isNumberOrTrue['default'](affixHorizontalScrollbar)) {
    ...
    _this.affixHorizontalScrollbar = function () {
      ...
      var windowHeight = getHeight['default'](window);
    ...
    _this.affixTableHeader = function () {
      ...
      if (_this.affixHeaderWrapperRef.current) {
        toggleClass['default'](_this.affixHeaderWrapperRef.current, 'fixed', fixedHeader);
      }
    };
    ...
    _this.handleColumnResizeEnd = function (columnWidth, _cursorDelta, dataKey, index) {
      ...
      addStyle['default'](_this.mouseAreaRef.current, {
        display: 'none'
      });
    };
    ...
    _this.handleColumnResizeMove = function (width, left, fixed) {
      ...
      if (_this.isRTL()) {
        mouseAreaLeft += _this.minScrollX + constants.SCROLLBAR_WIDTH;
        dir = 'right';
      }
      ...
      addStyle['default'](_this.mouseAreaRef.current, (_addStyle = {
        display: 'block'
    ...
    _this.handleWheel = function (deltaX, deltaY) {
      ...
      if (virtualized) {
        ...
        if (_this.disableEventsTimeoutId) {
          requestAnimationTimeout.cancelAnimationTimeout(_this.disableEventsTimeoutId);
        }

        _this.disableEventsTimeoutId = requestAnimationTimeout.requestAnimationTimeout(_this.debounceScrollEndedCallback, 150);
      }
    };
    ...
    _this.handleBodyScroll = function (event) {
      ...
      var left = scrollLeft['default'](event.target);
      var top = scrollTop['default'](event.target);
      ...
      scrollLeft['default'](event.target, 0);
      scrollTop['default'](event.target, 0);
    };
    ...
    _this.calculateTableWidth = function () {
      ...
      if (table) {
        var nextWidth = getWidth['default'](table);
    ...
    var _expandedRowKeys = defaultExpandAllRows ? findRowKeys['default'](data, _rowKey, isFunction['default'](renderRowExpanded)) : defaultExpandedRowKeys || [];

    var shouldFixedColumn = Array.from(flatten['default'](children)).some(function (child) {
    ...
    _this.state = {
      ...
      cacheData: data,
      data: isTree ? flattenData['default'](data) : data,
      width: _width || 0,
      columnWidth: 0,
      dataKey: 0,
      contentHeight: 0,
    ...
    _this.scrollY = 0;
    _this.scrollX = 0;
    _this.wheelHandler = new WheelHandler['default'](_this.listenWheel, _this.shouldHandleWheelX, _this.shouldHandleWheelY, false);
    _this._cacheChildrenSize = flatten['default'](children).length;
    _this.translateDOMPositionXY = translateDOMPositionXY.__exports.getTranslateDOMPositionXY({
      enable3DTransform: props.translate3d
    });
    _this.tableRef = /*#__PURE__*/React__namespace.createRef();
    _this.scrollbarYRef = /*#__PURE__*/React__namespace.createRef();
    _this.scrollbarXRef = /*#__PURE__*/React__namespace.createRef();
    _this.tableBodyRef = /*#__PURE__*/React__namespace.createRef();
    _this.affixHeaderWrapperRef = /*#__PURE__*/React__namespace.createRef();
    _this.mouseAreaRef = /*#__PURE__*/React__namespace.createRef();
    _this.headerWrapperRef = /*#__PURE__*/React__namespace.createRef();
    _this.wheelWrapperRef = /*#__PURE__*/React__namespace.createRef();
    _this.tableHeaderRef = /*#__PURE__*/React__namespace.createRef();
    return _this;
  }
  ...
  _proto.componentDidMount = function componentDidMount() {
    ...
    this.initPosition();
    index$1['default'](this.tableRef.current, debounce['default'](this.calculateTableWidth, 400));
    var options = {
      passive: false
    };
    ...
    if (tableBody) {
      this.wheelListener = on['default'](tableBody, 'wheel', this.wheelHandler.onWheel, options);
      this.touchStartListener = on['default'](tableBody, 'touchstart', this.handleTouchStart, options);
      this.touchMoveListener = on['default'](tableBody, 'touchmove', this.handleTouchMove, options);
    }
    ...
    if (isNumberOrTrue['default'](affixHeader) || isNumberOrTrue['default'](affixHorizontalScrollbar)) {
      this.scrollListener = on['default'](window, 'scroll', this.handleWindowScroll);
    }
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps, nextState) {
    var _cacheChildrenSize = flatten['default'](nextProps.children || []).length;
    /**
    ...
    return !eq['default'](this.props, nextProps) || !isEqual['default'](this.state, nextState);
  };
  ...
  _proto.componentWillUnmount = function componentWillUnmount() {
    ...
    if (this.tableRef.current) {
      index$1.unbind(this.tableRef.current);
    }
  ...
  _proto.isRTL = function isRTL$1() {
    return this.props.rtl || isRTL['default']();
  };
  ...
  _proto.getTableColumns = function getTableColumns() {
    ...
    var flattenColumns = flatten['default'](children).map(function (column) {
      if ((column === null || column === void 0 ? void 0 : column.type) === ColumnGroup['default']) {
        ...
        return childColumns.map(function (childColumn, index) {
          ...
          var groupCellProps = _extends['default']({}, childColumn === null || childColumn === void 0 ? void 0 : childColumn.props, {
            align: align,
            fixed: fixed,
          ...
          return /*#__PURE__*/React__namespace.cloneElement(childColumn, groupCellProps);
        });
      }
    ...
    return flatten['default'](flattenColumns).filter(function (col) {
      return col;
    });
  };
  ...
  _proto.getCellDescriptor = function getCellDescriptor() {
    ...
    var _getTotalByColumns = getTotalByColumns['default'](columns),
        totalFlexGrow = _getTotalByColumns.totalFlexGrow,
        totalWidth = _getTotalByColumns.totalWidth;

    var headerHeight = this.getTableHeaderHeight();
    React__namespace.Children.forEach(columns, function (column, index) {
      if ( /*#__PURE__*/React__namespace.isValidElement(column)) {
        ...
        var cellProps = _extends['default']({}, omit['default'](column.props, ['children']), {
        ...
        if (showHeader && headerHeight) {
          ...
          headerCells.push( /*#__PURE__*/React__namespace.cloneElement(columnChildren[0], _extends['default']({}, cellProps, headerCellProps)));
        }

        bodyCells.push( /*#__PURE__*/React__namespace.cloneElement(columnChildren[1], cellProps));
        left += nextWidth;
      }
    });
    return this._cacheCells = {
  ...
  _proto.initPosition = function initPosition() {
    ...
    if (this.isRTL()) {
      setTimeout(function () {
        ...
        _this3.scrollX = width - contentWidth - constants.SCROLLBAR_WIDTH;
  ...
  _proto.updatePosition = function updatePosition() {
    ...
    if (this.state.shouldFixedColumn) {
      ...
      wheelElement && addStyle['default'](wheelElement, wheelStyle);
      headerElement && addStyle['default'](headerElement, headerStyle);
      ...
      if (affixHeaderElement !== null && affixHeaderElement !== void 0 && (_affixHeaderElement$h = affixHeaderElement.hasChildNodes) !== null && _affixHeaderElement$h !== void 0 && _affixHeaderElement$h.call(affixHeaderElement)) {
        addStyle['default'](affixHeaderElement.firstChild, headerStyle);
      }
    }

    if ((_this$tableHeaderRef = this.tableHeaderRef) !== null && _this$tableHeaderRef !== void 0 && _this$tableHeaderRef.current) {
      toggleClass['default'](this.tableHeaderRef.current, this.addPrefix('cell-group-shadow'), this.scrollY < 0);
    }
  };
  ...
  _proto.updatePositionByFixedCell = function updatePositionByFixedCell() {
    ...
    var showRightShadow = width - contentWidth - constants.SCROLLBAR_WIDTH !== this.scrollX;
    toggleClass['default'](fixedLeftGroups, leftShadowClassName, showLeftShadow);
    toggleClass['default'](fixedRightGroups, rightShadowClassName, showRightShadow);
  };
  ...
  _proto.shouldRenderExpandedRow = function shouldRenderExpandedRow(rowData) {
    ...
    return isFunction['default'](renderRowExpanded) && !isTree && expandedRowKeys.some(function (key) {
  ...
  _proto.calculateTableContentWidth = function calculateTableContentWidth(prevProps) {
    ...
    var contentWidth = row ? getWidth['default'](row) : 0;
    this.setState({
      contentWidth: contentWidth
    }); // 这里 -SCROLLBAR_WIDTH 是为了让滚动条不挡住内容部分

    this.minScrollX = -(contentWidth - this.state.width) - constants.SCROLLBAR_WIDTH;
    /**
     * 1.判断 Table 列数是否发生变化
    ...
    if (flatten['default'](this.props.children).length !== flatten['default'](prevProps.children).length && this.state.contentWidth !== contentWidth) {
      this.scrollLeft(0);
    }
  };
  ...
  _proto.calculateTableContextHeight = function calculateTableContextHeight(prevProps) {
    ...
    var contentHeight = rows.length ? Array.from(rows).map(function (row) {
      return getHeight['default'](row) || rowHeight;
    }).reduce(function (x, y) {
      return x + y;
    ...
    if (!autoHeight) {
      // 这里 -SCROLLBAR_WIDTH 是为了让滚动条不挡住内容部分
      this.minScrollY = -(contentHeight - height) - constants.SCROLLBAR_WIDTH;
    ...
    if (Math.abs(this.scrollY) + height - headerHeight > nextContentHeight + constants.SCROLLBAR_WIDTH) {
  ...
  _proto.renderRowData = function renderRowData(bodyCells, rowData, props, shouldRenderExpandedRow) {
    ...
    var rowProps = _extends['default']({}, props, {
      key: nextRowKey,
    ...
    for (var i = 0; i < bodyCells.length; i++) {
      ...
      cells.push( /*#__PURE__*/React__namespace.cloneElement(cell, {
  ...
  _proto.renderRow = function renderRow(props, cells, shouldRenderExpandedRow, rowData) {
    ...
    var depth = props.depth,
        restRowProps = objectWithoutPropertiesLoose['default'](props, ["depth"]);
    ...
    if (shouldFixedColumn && contentWidth > width) {
      ...
      return /*#__PURE__*/React__namespace.createElement(Row['default'], _extends['default']({}, restRowProps, {
        "data-depth": depth,
        style: rowStyles
      }), fixedLeftCellGroupWidth ? /*#__PURE__*/React__namespace.createElement(CellGroup['default'], {
        fixed: "left",
      ...
      }, mergeCells['default'](resetLeftForCells['default'](fixedLeftCells))) : null, /*#__PURE__*/React__namespace.createElement(CellGroup['default'], null, mergeCells['default'](scrollCells)), fixedRightCellGroupWidth ? /*#__PURE__*/React__namespace.createElement(CellGroup['default'], {
        fixed: "right",
        style: this.isRTL() ? {
          right: 0 - rowRight
        } : {
          left: width - fixedRightCellGroupWidth - constants.SCROLLBAR_WIDTH
        },
        height: props.isHeaderRow ? props.headerHeight : props.height,
        width: fixedRightCellGroupWidth + constants.SCROLLBAR_WIDTH
      }, mergeCells['default'](resetLeftForCells['default'](fixedRightCells, constants.SCROLLBAR_WIDTH))) : null, shouldRenderExpandedRow && this.renderRowExpanded(rowData));
    }

    return /*#__PURE__*/React__namespace.createElement(Row['default'], _extends['default']({}, restRowProps, {
      "data-depth": depth,
      style: rowStyles
    }), /*#__PURE__*/React__namespace.createElement(CellGroup['default'], null, mergeCells['default'](cells)), shouldRenderExpandedRow && this.renderRowExpanded(rowData));
  };
  ...
  _proto.renderTableHeader = function renderTableHeader(headerCells, rowWidth) {
    ...
    var header = /*#__PURE__*/React__namespace.createElement("div", {
      className: cx__default['default'](this.addPrefix('affix-header')),
      style: fixedStyle,
      ref: this.affixHeaderWrapperRef
    }, this.renderRow(rowProps, headerCells));
    return /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, (affixHeader === 0 || affixHeader) && header, /*#__PURE__*/React__namespace.createElement("div", {
      role: "rowgroup",
  ...
  _proto.renderTableBody = function renderTableBody(bodyCells, rowWidth) {
      ...
      if (isUncertainHeight && virtualized || !virtualized) {
        for (var index = 0; index < data.length; index++) {
          ...
          if (typeof rowHeight === 'function') {
            ...
            nextRowHeight = maxHeight ? Math.max(maxHeight + constants.CELL_PADDING_HEIGHT, rowHeight) : rowHeight;
          ...
          if (isTree) {
            var parents = findAllParents['default'](rowData, rowKey);
            var expandedRowKeys = this.getExpandedRowKeys();
            depth = parents.length; //  如果是 Tree Table,  判断当前的行是否展开/折叠，如果是折叠则不显示该行。

            if (!shouldShowRowByExpanded['default'](expandedRowKeys, parents)) {
              continue;
            }
          }
    ...
    }, topHideHeight ? /*#__PURE__*/React__namespace.createElement(Row['default'], {
      style: topRowStyles,
      className: "virtualized"
    }) : null, this._visibleRows, bottomHideHeight ? /*#__PURE__*/React__namespace.createElement(Row['default'], {
  ...
  _proto.renderInfo = function renderInfo() {
    ...
    var emptyMessage = /*#__PURE__*/React__namespace.createElement("div", {
  ...
  _proto.renderScrollbar = function renderScrollbar() {
    ...
    return /*#__PURE__*/React__namespace.createElement("div", null, /*#__PURE__*/React__namespace.createElement(Scrollbar['default'], {
      tableId: id,
    ...
    }), /*#__PURE__*/React__namespace.createElement(Scrollbar['default'], {
      vertical: true,
      tableId: id,
  ...
  _proto.renderLoading = function renderLoading() {
    ...
    var loadingElement = /*#__PURE__*/React__namespace.createElement("div", {
  ...
  _proto.render = function render() {
    ...
    var _this$props26 = this.props,
        ...
        rest = objectWithoutPropertiesLoose['default'](_this$props26, ["children", "className", "data", "width", "style", "isTree", "hover", "bordered", "cellBordered", "wordWrap", "classPrefix", "loading", "showHeader"]);
    ...
    return /*#__PURE__*/React__namespace.createElement(TableContext['default'].Provider, {
      value: {
    ...
    }, /*#__PURE__*/React__namespace.createElement("div", _extends['default']({
...
Table.defaultProps = {
  classPrefix: prefix.defaultClassPrefix('table'),
  data: [],
