...
import { r as reactIs } from '../../../../_virtual/index.js_commonjs-module3.js';
...
function getTableColumns(children) {
  ...
  var flattenColumns = flatten_1(childrenArray).map(function (column) {
    ...
    if ((column === null || column === void 0 ? void 0 : column.type) === ColumnGroup) {
      ...
      return childColumns.map(function (childColumn, index) {
        ...
        return /*#__PURE__*/React__default.cloneElement(childColumn, groupCellProps);
      });
    } else if (reactIs.exports.isFragment(column)) {
      var _column$props2;
  ...
  return flatten_1(flattenColumns).filter(Boolean);
}

export { getTableColumns as default };
