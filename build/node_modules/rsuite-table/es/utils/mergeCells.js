...
function cloneCell(Cell, props) {
  return /*#__PURE__*/React__default.cloneElement(Cell, props);
}
  ...
  for (var i = 0; i < cells.length; i += 1) {
    ...
    if (groupCount && isHeaderCell) {
      ...
      for (var j = 0; j < groupCount; j += 1) {
        ...
        groupChildren.push( /*#__PURE__*/React__default.createElement(HeaderCell, {
          key: j,
          left: left,
          align: align,
      ...
      nextCells.push(cloneCell(cells[i], {
        width: nextWidth,
        children: /*#__PURE__*/React__default.createElement(ColumnGroup, {
          width: nextWidth,
      ...
      for (var _j = 0; _j < colSpan; _j += 1) {
        ...
        if (_nextCell) {
          ...
          var cellText = isFunction_1(_children) ? _children(rowData, rowIndex) : get_1(rowData, _dataKey);

          if (rowData && isNil_1(cellText) || _isHeaderCell && isNil_1(_children)) {
