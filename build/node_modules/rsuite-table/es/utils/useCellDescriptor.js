...
import merge_1 from '../../../lodash/merge.js';
import { SCROLLBAR_WIDTH, SORT_TYPE } from '../constants.js';
import useControlled from './useControlled.js';
import getTableColumns from './getTableColumns.js';
import getTotalByColumns from './getTotalByColumns.js';
...
var useCellDescriptor = function useCellDescriptor(props) {
  ...
  React__default.Children.forEach(columns, function (column, index) {
    if ( /*#__PURE__*/React__default.isValidElement(column)) {
      ...
      var cellProps = _extends({}, omit_1(column.props, ['children']), {
      ...
      if (showHeader && headerHeight) {
        ...
        headerCells.push( /*#__PURE__*/React__default.cloneElement(headerCell, _extends({}, cellProps, headerCellProps)));
      }

      bodyCells.push( /*#__PURE__*/React__default.cloneElement(cell, cellProps));
      left += cellWidth;
    }
  });
  var cacheCell = {
...
export { useCellDescriptor as default };
