...
var Badge = function (_a) {
    ...
    return (jsxRuntime.jsx("span", tslib_es6.__assign({ className: index['default'](Badge_module['default'].wrapper, Badge_module['default'][variant], (_b = {}, _b[Badge_module['default'].pill] = pill, _b), className) }, props, { children: children }), void 0));
};
