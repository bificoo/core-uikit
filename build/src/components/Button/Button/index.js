...
var Button = function (_a) {
    ...
    var _h = React.useContext(ButtonContext.ButtonContext), activeKey = _h.activeKey, setActiveKey = _h.setActiveKey, selectKey = _h.selectKey;
    return (jsxRuntime.jsx("button", _tslib.__assign({ className: cx__default['default']("core-uikit-button", Button_module['default'].wrapper, Button_module['default'][variant], (_b = {}, _b[Button_module['default'].block] = block, _b), (_c = {}, _c[Button_module['default'].selected] = selected && selectKey === eventKey, _c), { active: eventKey && eventKey === activeKey }, className), onClick: function (e) {
            if (eventKey) {
