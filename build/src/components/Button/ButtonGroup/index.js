...
var ButtonGroup = function (props) {
    ...
    return (jsxRuntime.jsx(ButtonContext.ButtonContext.Provider, _tslib.__assign({ value: { activeKey: eventKey, setActiveKey: handleClickItem } }, { children: jsxRuntime.jsx("div", _tslib.__assign({ className: ButtonGroup_module['default'].outer }, { children: props.children }), void 0) }), void 0));
};
