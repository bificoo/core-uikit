...
var Button = function (_a) {
    ...
    return (jsxRuntime.jsx("a", _tslib.__assign({ className: cx__default['default'](LinkButton_module.wrapper, LinkButton_module[variant], className) }, props, { children: children }), void 0));
};
