...
var CollapseHeader = function (props) {
    ...
    return (jsxs("header", __assign({ className: cx(props.className, styled.wrapper), onClick: function () { return setExpanded(!expanded); }, style: props.style }, { children: [props.children, " ", jsx(Icon, { name: !expanded ? "arrow-up" : "arrow-down", style: { marginLeft: "4px" } })] })));
};
