...
import { __exports as build } from '../../../../_virtual/index.js_commonjs-exports';
...
var RangePicker = function (_a) {
    ...
    return (jsx("div", __assign({ ref: datePickerContainerRef }, { children: jsx(DayPickerInput, { ref: datePickerInputRef, classNames: {
                ...
                formatDate(new Date(), dateFormat) + " ~ " + formatDate(new Date(), dateFormat), hideOnDayClick: false, component: function (props) { return (jsx(DateFormControl, __assign({ startDate: startDate, endDate: endDate, dateFormat: dateFormat }, props), void 0)); }, dayPickerProps: dayPickerProps, onDayChange: handleDayChange }, void 0) }), void 0));
};
