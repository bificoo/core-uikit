...
var FormInput = React__default.forwardRef(function FormInput(_a, ref) {
    ...
    return (jsx("div", __assign({ className: cx("component-input", styled.wrapper, (_b = {},
            ...
            _b)) }, { children: jsx("input", __assign({}, props, { ref: ref, type: type, id: attributes === null || attributes === void 0 ? void 0 : attributes.formId, className: cx(styled.control, className), onChange: function (e) {
