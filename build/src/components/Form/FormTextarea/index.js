...
var FormTextarea = React__default['default'].forwardRef(function FormTextarea(_a, ref) {
    ...
    return (jsxRuntime.jsx("div", tslib_es6.__assign({ className: index['default']("component-textarea", FormTextarea_module['default'].wrapper, (_b = {},
            ...
            _b)) }, { children: jsxRuntime.jsx("textarea", tslib_es6.__assign({}, props, { ref: ref, id: attributes === null || attributes === void 0 ? void 0 : attributes.formId, className: index['default'](FormTextarea_module['default'].control, className), onChange: function (e) {
