...
var Table = function (_a) {
    ...
    return (jsxs("div", __assign({ className: styled.wrapper }, { children: [jsx(Table$1, __assign({}, props, { autoHeight: true, data: visualData, renderLoading: function () { return props.loading && jsx(QueryStatus.Loading, {}, void 0); } }), void 0), data && data.length !== 0 && (jsx(Pagination, { maxButtons: maxButtons, pages: Math.ceil(data.length / limit), activePage: page > Math.ceil(data.length / limit) ? 1 : page, total: data.length, limitMenu: limitMenu, limit: limit, renderTotal: typeof renderTotal === "function" ? function () { return renderTotal(data.length); } : renderTotal, onSelect: handleSelect, onLimitChange: handleChangeLength }, void 0))] }), void 0));
};
Table.Column = Column;
