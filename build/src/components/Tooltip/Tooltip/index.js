...
var Tooltip = function (_a) {
    ...
    return (jsx(Popup, __assign({ className: "core-tooltip", trigger: jsx("span", { children: tooltip.trigger }), on: on, position: position, closeOnDocumentClick: true, contentStyle: tooltip.bodyStyle, arrow: true, arrowStyle: { display: "none" } }, { children: jsx("span", { children: tooltip.body }) })));
};
